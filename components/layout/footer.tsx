...
export function Footer() {
  return (
    <footer className="w-full bg-canvas border-t border-hairline/80 py-12 select-none">
      <div className="max-w-[1280px] mx-auto px-6 flex flex-col space-y-6 md:flex-row md:items-center md:justify-between md:space-y-0 text-body-sm text-ink-subtle">
